                ...
                <div class="row">
                    <div class="column column_1_3">
                        ...
                        <p class="padding_top_bottom_25">
                            AIA Team merupakan sebuah team yang bergerak dibidang jasa, banyak layanan yang AIA Team tawarkan untuk memenuhi kebutuhan user dan layanan kami terdiri beberapa paket yang hight quality.
                        </p>
                    </div>
                    <div class="column column_1_3">
                        <h4 class="box_header">Kontak</h4>
                        <p class="padding_top_bottom_25">
                            Jl. Cempaka Putih Tengah No. 27 Cemapaka Putih Jakarta Pusat<br /><br />
                            Phone: (+62) 896-7328-7943<br />
                            Website: www.aiaTeam.com
                        </p>
                    </div>
                    <div class="column column_1_3">
                        <h4 class="box_header">Social Media</h4>
                        <ul class="social_icons dark page_margin_top clearfix">
                            <li><a target="_blank" title="" href="jkjjkj" class="social_icon facebook">&nbsp;</a></li>
