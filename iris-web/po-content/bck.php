                        ...
                        ?>
                            <li class="slide">
                                <a href="<?php echo "$website_url/detailpost/$slider->seotitle"; ?>" title="<?=$slider->title;?>">
                                    <img src="<?=$website_url;?>/po-content/po-upload/<?=$slider->picture;?>" alt="<?=$slider->title;?>" class="img-responsive">
                                </a>
            ...
            <div class="page_layout clearfix">
                <div class="row page_margin_top">
                    <div class="column column_2_3">
                                ...
                                ?>
                                    <li class="post">
                                        ...
                                        <div class="post_content">
                                            ...
                                            <ul class="post_details simple">
                                                <li class="category"><a href="<?php echo "$website_url/category/materi"; ?>" title="Materi">MATERI</a></li>
                        ...
                        <div class="row page_margin_top_section">
                            <h4 class="box_header">Profil Kami</h4>
                            <div class="row">
                                ...
                                ?>
                                    <li class="post">
                                        ...
                                        <ul class="post_details">
                                            <li class="category"><a href="<?php echo "$website_url/category/Profil"; ?>" title="PROFIL KAMI">PROFIL KAMI</a></li>
                                ...
                                <div class="column column_1_2">
                                    ...
                                    ?>
                                        <li class="post">
                                            ...
                                            <div class="post_content">
                                                ...
                                                <ul class="post_details simple">
                                                    <li class="category"><a href="<?php echo "$website_url/category/Profil"; ?>" title="PROFIL">PROFIL</a></li>
                                    ...
                                    <a class="more page_margin_top" href="<?php echo "$website_url/category/Profil"; ?>">INDEX PROFIL</a>
                                </div>
                            </div>
                        </div>

                        <h4 class="box_header page_margin_top_section">Layanan</h4>
                        <div class="row">
                            <ul class="blog big">
                            <?php
                            ...
                            ?>
                                <li class="post">
                                    ...
                                    <div class="post_content">
                                        ...
                                        <ul class="post_details">
                                            <li class="category"><a href="<?php echo "$website_url/category/layanan"; ?>" title="layanan">LAYANAN</a></li>
